...
#
#sitemods       = '/home/brapp/git/ISatSS_NCEP/DeLorean'
sitemods       = '/home/brapp/git/ISatSS-config/SPC'
...
localhosts = {}
localhosts['S1'] = {}
localhosts['S1'][1] = {'host':['ninja.dilireum.org'], 'shortname':'brapp', 'user':'brapp'}
localhosts['S1'][2] = {'host':['ninja.dilireum.org'], 'shortname':'ldm', 'user':'ldm', 'ext':1338, 'cmd':6, 'resp':7}

localfstypes = {}
localfstypes['fastest'] = {'root':'/dev/shm/isatss_data',      'filesystem':'/dev/shm',     'stype':'attached'}
localfstypes['grb']     = {'root':'/mnt/ramdisk',              'filesystem':'/mnt/ramdisk', 'stype':'attached'}
localfstypes['local']   = {'root':'/scratch/isatss_data',      'filesystem':'/scratch/isatss_data',  'stype':'attached'}
localfstypes['backup']  = {'root':'/data/isatss_data/nfsbak',  'filesystem':'/data',         'stype':'attached'}
localfstypes['storage'] = {'root':'/data/isatss_data/nfsops',  'filesystem':'/nfsops',      'stype':'attached'}

'''
localhosts = {}
localhosts['AWS1'] = {}
localhosts['AWS1'][1] = {'host':['ninja.dilireum.org'], 'shortname':'ninja'}
localhosts['AWS1'][2] = {'host':['ninja.dilireum.org'], 'shortname':'ninja-root', 'user': 'root'}

localfstypes = {}
localfstypes['fastest']   = {'root':'/dev/shm/isatss_data',  'filesystem':'/dev/shm',    'stype':'attached'}
localfstypes['local']     = {'root':'/awips2/isatss_data',   'filesystem':'/local/iops', 'stype':'attached'}
localfstypes['ephemeral'] = {'root':'/ephemeral',            'filesystem':'/ephemeral',  'stype':'attached'}
'''
