...
#sitemods       = '/home/brapp/git/ISatSS-config/TOWR'
sitemods        = '/home/brapp/git/ISatSS-config/DeLorean'
...
localhosts = {}
localhosts['GCP'] = {}
localhosts['GCP'][1] = {'host':['ninja.dilireum.org'], 'shortname':'ldm', 'user':'brapp', }
localhosts['GCP'][2] = {'host':['ninja.dilireum.org'], 'shortname':'ildm', 'user':'ldm', 'ext':1338, 'cmd':5, 'resp':6}
'''
...
localfstypes['stores']    = {'root':'/data',                 'filesystem':'/l',          'stype':'attached'}
