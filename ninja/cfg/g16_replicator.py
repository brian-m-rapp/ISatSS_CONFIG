...
job = {}
job['name']       = 'g16_replicator'
job['cmd']        = 'mojo'
job['class']      = 'Mojo'
job['log']        = 'g16_replicator_log'
job['log_node']   = 1
...
job['input_type']['name']          = 'BMR_ISatSS_GOES16_Queue'
...
pargs['outputs']['abi']['path']         = {'calc':'file Get Basename'}
...
pargs['outputs']['glm']['path']         = {'calc':'file Get Basename'}
