...
job['data'] = {}
job['data']['jfiles']                 = {}
job['data']['jfiles']['location']       = {'node':103}
...
job['data']['jinfo'] = {}
job['data']['jinfo']['location']     = {'node':102}
job['data']['jinfo']['aging']        = {'window':3600, 'mode':'creationtime'}
job['data']['jinfo']['method']       = {'technique':'inplace'}
job['data']['jinfo']['activeonly']   = True
job['data']['jinfo']['schedule']     = {'interval':600}

job['data']['jledger']                = {}
job['data']['jledger']['location']    = {'node':100}
...
job['notifications']   = {}
job['notifications']['jason']    = {'node':job['data']['jinfo']['location']['node'], 'enabled':True, 'fields':['file','node'], 'prefix':'jason'}
...
job['sources'] = {}
job['sources']['nodc'] =  {'protocol':'FTP', 'host':'ftp.nodc.noaa.gov', 'authid':4, 'timeout':10, 'retry':10,'paths':{},'sessions':1}
...
jason3_args = {'window':86400, 'cyclecount':None, 'date_from':'stamp', 'date_format':None}
