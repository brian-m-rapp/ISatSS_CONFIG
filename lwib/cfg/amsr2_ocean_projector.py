...
ncspec['variables']['Rain_Rate']['fmt']                     = {'default':'i2'}
...
ncspec['variables']['Rain_Rate']['data']                    = {'src':'data/Rain_Rate', 'map':{-9999.0:65535},'fmt':'i2'}
...
ncspec['variables']['WSPD']['fmt']                     = {'default':'i2'}
...
ncspec['variables']['TPW']['fmt']                     = {'default':'i2'}
...
ncspec['variables']['CLW']['fmt']                     = {'default':'i2'}
...
ncspec['variables']['SST']['fmt']                     = {'default':'i2'}
