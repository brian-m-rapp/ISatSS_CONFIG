...
job['notifications']   = {}
job['notifications']['gcom']   = {'node':241, 'enabled':True, 'fields':['file', 'node'], 'prefix':'gcom'}

job['data'] = {}
job['data']['gfiles']                 = {}
job['data']['gfiles']['location']       = {'node':242}
...
job['data']['gledger']                = {}
job['data']['gledger']['location']    = {'node':10}
