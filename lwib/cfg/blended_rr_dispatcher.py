...
job = {}
job['name']     = 'blended_rr_dispatcher'
job['cmd']      = 'dispatcher'
job['class']    = 'Dispatcher'
job['log']      = 'blended_rr_dispatch_log'
job['log_node'] = 1


job['notifications']   = {}
job['notifications']['blended']   = {'node':152, 'enabled':True, 'fields':['file', 'node'], 'prefix':'blended'}

job['data'] = {}
job['data']['afiles']                 = {}
job['data']['afiles']['location']       = {'node':151}
...
blended_args['filter'] = {'filt':'substring','target':'name','startswith':'BHP-RR_blend','name':'Blended hydro RR'}
