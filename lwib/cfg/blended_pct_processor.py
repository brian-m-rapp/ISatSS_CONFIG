...
job = {}
job['name']     = 'blended_pct_processor'
job['cmd']      = 'mojo'
job['class']    = 'MOJO'
job['log']      = 'blended_pct_processor_log'
job['log_node'] = 1
...
job['input_type']           = {'type':'infofile','node':157,'delete_file':True, 'delete_info':True}
...
ncspec['variables']['PCT']   = {}
ncspec['variables']['PCT']['fmt']                    = {'default':'f4'}
ncspec['variables']['PCT']['shape']                  = {'default':['lat','lon']}
ncspec['variables']['PCT']['fill_value']             = {'default':-999.}
ncspec['variables']['PCT']['zlib']                   = {'default':True}
ncspec['variables']['PCT']['complevel']              = {'default':1}
ncspec['variables']['PCT']['shuffle']                = {'default':True}
ncspec['variables']['PCT']['data']                   = {'src':'data/PCT'}
ncspec['variables']['PCT']['attrs'] = {}
ncspec['variables']['PCT']['attrs']['coordinates']   = {'default':['Latitude Longitude']}
ncspec['variables']['PCT']['attrs']['long_name']     = {'default':'Percentage of TPW Normal'}
ncspec['variables']['PCT']['attrs']['units']         = {'default':'%'}
