...
job = {}
job['name']     = 'blended_tpw_dispatcher'
job['cmd']      = 'dispatcher'
job['class']    = 'Dispatcher'
job['log']      = 'blended_tpw_dispatch_log'
job['log_node'] = 1


job['notifications']   = {}
job['notifications']['blended']   = {'node':147, 'enabled':True, 'fields':['file', 'node'], 'prefix':'blended'}

job['data'] = {}
job['data']['afiles']                 = {}
job['data']['afiles']['location']       = {'node':146}
...
blended_args['filter'] = {'filt':'substring','target':'name','startswith':'BHP-TPW_blend','name':'Blended hydro'}
