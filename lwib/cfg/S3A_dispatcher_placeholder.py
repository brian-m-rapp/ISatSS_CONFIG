...
job = {}
job['name']     = 'S3A_dispatcher_placeholder'
job['cmd']      = 'dispatcher'
job['class']    = 'Dispatcher'
job['log']      = 'S3A_dispatch_log'
job['log_node'] = 1


job['notifications']   = {}
job['notifications']['jason']   = {'node':137, 'enabled':True, 'fields':['file', 'node'], 'prefix':'jason'}

job['data'] = {}
job['data']['jfiles']                 = {}
job['data']['jfiles']['location']       = {'node':91}
...
job['data']['jledger']                = {}
job['data']['jledger']['location']    = {'node':10}
...
jason2_args = {'window':21600, 'cyclecount':None, 'date_from':'stamp', 'date_format':None}
...
jason3_args = {'window':21600, 'cyclecount':None}
