...
job = {}
job['name']     = 'blended_tpw_processor'
job['cmd']      = 'mojo'
job['class']    = 'MOJO'
job['log']      = 'blended_tpw_processor_log'
job['log_node'] = 1
...
job['input_type']           = {'type':'infofile','node':147,'delete_file':True, 'delete_info':True}
...
ncspec['variables']['TPW']['shape']                  = {'default':['lat','lon']}
ncspec['variables']['TPW']['fill_value']             = {'default':-999.}
...
ncspec['variables']['TPW']['attrs']['coordinates']   = {'default':['Latitude Longitude']}
ncspec['variables']['TPW']['attrs']['long_name']     = {'default':'Blended Total Precipitable Water'}
