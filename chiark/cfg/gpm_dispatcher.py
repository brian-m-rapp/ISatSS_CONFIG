...
job['notifications']   = {}
job['notifications']['gpm']   = {'node':111, 'enabled':True, 'fields':['file', 'node'], 'prefix':'gpm'}

job['data'] = {}
job['data']['afiles']                 = {}
job['data']['afiles']['location']       = {'node':112}
...
job['sources'] = {}
job['sources']['satepsanone'] =  {'protocol':'HTTPS', 'host':'satepsanone.nesdis.noaa.gov', 'authid':3, 'timeout':10, 'retry':10,'paths':{},'sessions':1}
