...
job = {}
job['name']  = 'g16_george_meso'
job['cmd']   = 'george'
job['class'] = 'GeoRGE'
job['log']   = 'g16_george_meso_log'
job['log_id'] = 1
...
job['input_type']  = {'type':'infofile','node':10,'delete_file':True, 'delete_info':True}

job['cntl_node']     = 29

job['notifications'] = {'ncm':{'node':8,'enabled':True,'prefix':'meso'}}
