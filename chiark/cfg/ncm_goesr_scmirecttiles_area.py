...
job['data']  = {}
job['data']['products'] = {}
job['data']['products']['location'] = {'node':14,'type':'datapath','path':'area'}
job['data']['products']['links']    = {'link1':{'node':10,'path':'goes16'}}
job['data']['products']['aging']    = {'window':86400, 'mode':'nested','fmt':'%y%m%d_%H%M','extract':{'method':'tail','nchars':11}}
...
job['cntl_node']     = 9
job['notifications'] = {}
job['notifications']['finish'] = {'node':6,'enabled':False}
job['notifications']['mon']    = {'node':16,'enabled':True,'fields':['file'],'prefix':'abi_area_mon'}
job['links']         = {'link1':{'enabled':True}}
job['dots']          = False
...
job['inputs']['M2_15'] = {}
job['inputs']['M2_16'] = {}
job['inputs']['SPECIAL_16'] = {}

job['defaults']['outputs'] = {}
job['defaults']['outputs']['pathdef'] = []
job['defaults']['outputs']['pathdef'].append({'src':'globalmeta/output_product_name','fmt':'str','translate':{'Full Disk':'FD','CONUS':'CONUS','Mesoscale-1':'MESO1','Mesoscale-2':'MESO2'},'delimiter':'/'})
job['defaults']['outputs']['pathdef'].append({'src':'globalmeta/central_wavelength','fmt':'str','method':'char_replace','oldchar':'.','newchar':'p','delimiter':''})
...
job['defaults']['outputs']['namedef'].append({'src':'globalmeta/output_product_name', 'fmt':'str','translate':{'Full Disk':'FD','CONUS':'CO','Mesoscale-1':'M1','Mesoscale-2':'M2'},'delimiter':'_'})
...
job['defaults']['outputs']['notify'] = ['finish']
...
job['outputs'][65] = {}
job['outputs'][65]['input'] = 'SPECIAL_16'
