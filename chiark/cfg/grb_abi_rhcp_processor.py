...
job['inpath']        = {'node':42,'path':'abi'}
job['notifications'] = {}
job['notifications']['ldm']   = {'node':1, 'enabled':False,'fields':['file','prodid','wmo'],'prefix':'abi_rhcp_ldm'}
job['notifications']['area']  = {'node':10, 'enabled':True, 'fields':['file'],'prefix':'abi_rhcp_area'}
job['notifications']['marea'] = {'node':12,'enabled':True, 'fields':['file'],'prefix':'abi_rhcp_marea'}
