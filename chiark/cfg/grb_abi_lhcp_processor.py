...
job['notifications'] = {}
job['notifications']['ldm']   = {'node':6, 'enabled':True,'fields':['file','node','prodid','wmo'],'prefix':'abi_lhcp_ldm'}
job['notifications']['area']  = {'node':12,'enabled':True,'fields':['file','node'],'prefix':'abi_lhcp_area'}
job['notifications']['marea'] = {'node':10,'enabled':True,'fields':['file','node'],'prefix':'abi_lhcp_marea'}
...
job['data']['infomarea']               = {}
job['data']['infomarea']['location']   = {'node':11,'type':'infopath'}
