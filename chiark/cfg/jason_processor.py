...
job['data'] = {}
job['data']['output'] = {}
job['data']['output']['location']   = {'node':94}
...
job['data']['info']                = {}
job['data']['info']['location']    = {'node':54}
...
job['input_type']           = {'type':'infofile','node':92,'delete_file':True, 'delete_info':True}
...
ncspec['namedef']     = []
ncspec['namedef'].append({'default':'jason','delimiter':'_'})
...
ncspec['variables']['lon']['data']                   = {'src':'data/lon','mapscalefac':{-999.:{'scale':1e-06}},'fmt':'f8'}
...
ncspec['variables']['time']['data']                   = {'src':'data/time', 'trucate':60}
