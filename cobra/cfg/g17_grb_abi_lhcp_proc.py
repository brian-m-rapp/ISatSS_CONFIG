...
job = {}
job['name']          = 'g17_grb_abi_lhcp_processor'
job['cmd']           = 'grber'
job['class']         = 'GRBProc'
job['log']           = 'g17_grb_abi_lhcp_processor_log'
job['log_node']      = 1

job['inpath']        = {'node':587,'path':'abi'}	#587
job['cfginputs']     = [88]
job['apids']         = {}
...
job['data']['infoarea']['filter']     = {'type':'starts','test':'abi_lhcp'}
