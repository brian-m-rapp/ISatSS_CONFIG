...
job = {}
job['name']          = 'grb_abi_processor'
job['cmd']           = 'grber'
job['class']         = 'GRBProc'
job['log']           = 'grb_abi_processor_log'

job['inpath']        = '/mnt/ramdisk/grb_live/abi'
job['notifications'] = {'ldm':{'node':1,'enabled':False},'area':{'node':4,'enabled':True}}
job['read_node']     = 3
...
job['data'] = {}
job['data']['products']               = {}
job['data']['products']['location']   = {'node':7, 'path':'abi'}
...
job['data']['info']                   = {}
job['data']['info']['location']       = {'node':0,'type':'infopath'}
job['data']['info']['mode']           = 'filter'
job['data']['info']['filter']         = 'abildm_'
...
job['data']['log']                    = {}
job['data']['log']['location']            = {'node':12,'path':'log'}
