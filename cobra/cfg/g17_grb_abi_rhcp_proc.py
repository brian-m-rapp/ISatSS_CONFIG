...
job = {}
job['name']          = 'g17_grb_abi_rhcp_processor'
job['cmd']           = 'grber'
job['class']         = 'GRBProc'
job['log']           = 'g17_grb_abi_rhcp_processor_log'
job['log_node']      = 1

job['inpath']        = {'node':588,'path':'abi'}
job['cfginputs']     = [87]
...
job['data']['infoarea']['filter']     = {'type':'starts','test':'abi_rhcp'}
