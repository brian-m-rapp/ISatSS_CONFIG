...
job = {}
job['name']     = 'sentinel_processor'
job['cmd']      = 'mojo'
job['class']    = 'MOJO'
job['log']      = 'sentinel_processor_log'
job['log_node'] = 1

job['data'] = {}
job['data']['output'] = {}
job['data']['output']['location']   = {'node':144}
...
job['data']['info']                = {}
job['data']['info']['location']    = {'node':145}
...
ncspec['namedef']     = []
ncspec['namedef'].append({'default':'isatss_sentinel_napo','delimiter':'_'})
...
ncspec['globalmeta'] = {}
ncspec['globalmeta']['mission_name']                = {'src':'inncf/globalmeta/mission_name', 'fmt':'str', 'translate':{'Sentinel 3A':'Sentinel-3A', 'Sentinel 3B':'Sentinel-3B'}}
...
ncspec['variables']['time_01']['attrs']['long_name']     = {'default':'Sentinel scan start time, seconds since 2000-01-01 00:00:00'}
...
ncspec['notifications']['targets']['orbits']  = {'node':job['data']['info']['location']['node'], 'enabled':True, 'prefix':'sentinel3', 'fields':['file','node']}
