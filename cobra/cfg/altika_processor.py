...
ncspec['variables']['lat']['fmt']                    = {'default':'i4'}
...
ncspec['variables']['lat']['attrs']['scale_factor']  = {'default':1e-6}
...
ncspec['variables']['lon']['fmt']                    = {'default':'i4'}
...
ncspec['variables']['lon']['attrs']['scale_factor']  = {'default':1e-6}
...
ncspec['variables']['time']['attrs']['calendar']           = {'default':'gregorian'}
ncspec['variables']['time']['attrs']['tai_utc_difference'] = {'default':-37.0}
ncspec['variables']['time']['attrs']['leap_second']        = {'default':'1970-01-01 00:00:00'}
ncspec['variables']['time']['attrs']['comment']            = {'default':'[tai_utc_difference] is the difference between TAI and UTC reference time (seconds) for the first measurement of the data set. [leap_second] is the UTC time at which a leap second occurs in the data set, if any. After this UTC time, the [tai_utc_difference] is increased by 1 second'}

ncspec['variables']['swh']   = {}
ncspec['variables']['swh']['fmt']                    = {'default':'i2'}
...
ncspec['variables']['swh']['attrs']['scale_factor']  = {'default':.001}
...
ncspec['variables']['DQF']['fill_value']             = {'default':127}
ncspec['variables']['DQF']['zlib']                   = {'default':True}
ncspec['variables']['DQF']['complevel']              = {'default':1}
ncspec['variables']['DQF']['shuffle']                = {'default':True}
ncspec['variables']['DQF']['data']                   = {'src':'data/surface_type'}
ncspec['variables']['DQF']['attrs'] = {}
ncspec['variables']['DQF']['attrs']['flag_values']   = {'default':[0, 1, 2, 3]}
ncspec['variables']['DQF']['attrs']['flag_meanings'] = {'default':'ocean lake_enclosed_sea ice land'}
ncspec['variables']['DQF']['attrs']['long_name']     = {'default':'surface type'}
ncspec['variables']['DQF']['attrs']['coordinates']   = {'default':['lon, lat']}
ncspec['variables']['DQF']['attrs']['comment']       = {'default':'Computed using a DTM2000 file: 0 = open oceans or semi-enclosed seas; 1 = enclosed seas or lakes; 2 = continental ice; 3 = land. See SARAL User Handbook'}

ncspec['variables']['wind_speed_alt']   = {}
ncspec['variables']['wind_speed_alt']['fmt']                    = {'default':'i2'}
ncspec['variables']['wind_speed_alt']['shape']                  = {'default':['time']}
ncspec['variables']['wind_speed_alt']['fill_value']             = {'default':32767}
...
ncspec['variables']['wind_speed_alt']['data']                   = {'src':'data/wind_speed_alt'}
...
ncspec['variables']['wind_speed_alt']['attrs']['scale_factor']  = {'default':.01}
