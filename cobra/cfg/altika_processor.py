...
ncspec['variables']['swh']['fill_value']             = {'default':32767.0}
ncspec['variables']['swh']['zlib']                   = {'default':True}
ncspec['variables']['swh']['complevel']              = {'default':1}
ncspec['variables']['swh']['shuffle']                = {'default':True}
ncspec['variables']['swh']['data']                   = {'src':'data/swh', 'mapscalefac':{32767:{'scale':1e-3}}, 'fmt':'f4'}
...
ncspec['variables']['wind_speed_alt']['fill_value']             = {'default':32767.0}
...
ncspec['variables']['wind_speed_alt']['data']                   = {'src':'data/wind_speed_alt', 'mapscalefac':{32767:{'scale':.01}}, 'fmt':'f4'}
