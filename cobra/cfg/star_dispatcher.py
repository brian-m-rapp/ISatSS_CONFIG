...
job['data'] = {}
job['data']['h8slab']                 = {}
job['data']['h8slab']['location']       = {'node':77}
...
job['data']['infoslab']                = {}
job['data']['infoslab']['location']    = {'node':76}
...
job['data']['slabledger']                = {}
job['data']['slabledger']['location']    = {'node':61}
...
ahiargs['ledger'] = {'node':job['data']['slabledger']['location']['node'],'name':'himawari.ledger'}
